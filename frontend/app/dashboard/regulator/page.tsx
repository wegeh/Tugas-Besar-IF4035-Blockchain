    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">Regulator Overview</h1>
                    <p className="text-muted-foreground">Manage compliance periods and allocations</p>
                </div>
                                    ...
                                    <TableCell>
                                        <span className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium 
                                            ${period.status === 'ACTIVE' ? 'bg-green-100 text-green-800' :
                                                period.status === 'AUDIT' ? 'bg-yellow-100 text-yellow-800' :
